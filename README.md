...
- **[Provider Ops RBAC Platform](https://github.com/alpha5611331/provider-ops-demo)** - HIPAA-conscious Provider Operations Platform demo replacing manual billing approval with an auditable, role-based system. *Stack: FastAPI · MongoDB (Motor, async) · Pydantic V2 · JWT Auth (python-jose, bcrypt) · Next.js · React · Tailwind CSS · Docker*
